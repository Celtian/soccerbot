...
describe('SoccerBotSoccerwayClient', () => {
  ...
  describe('leagueUrl',() => {
    it('should return correct value', () => {
      expect(client.leagueUrl('r59164','20202021'))
       .toEqual('https://int.soccerway.com/national/country-slug/team-slug/20202021/regular-season/r59164/tables/');
    })
  ...
  describe('league',() => {
    beforeEach(() => {
      const handleSpy = spyOn(SoccerBotSoccerwayClient.prototype as any, 'fetchPage');
  ...
  describe('team',() => {
    beforeEach(() => {
      ...
      const handlePlayerSpy = spyOn(SoccerBotSoccerwayClient.prototype as any, 'player');
      handlePlayerSpy.and.callFake(() => {
        return new Promise((resolve) => {
          resolve(PLAYER_DATA);
        });
      });

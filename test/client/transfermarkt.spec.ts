...
describe('SoccerBotTransfermarktClient', () => {
  ...
  describe('leagueUrl', () => {
    it('should return correct value', () => {
      expect(client.leagueUrl('TS1')).toEqual('https://www.transfermarkt.com/slug/startseite/wettbewerb/TS1');
      expect(client.leagueUrl('TS1', '2018')).toEqual(
        'https://www.transfermarkt.com/slug/startseite/wettbewerb/TS1/plus?saison_id=2018'
      );
    });
